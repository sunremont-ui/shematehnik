...
- richer style/theme tokens, fonts and a fuller asset pipeline (formats beyond RGB565/RGB565A8, asset folder/skeleton export) beyond the current inline manifest;
