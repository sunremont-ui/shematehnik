...
1. [ ] **Диод** — модель Шокли, Ньютон-Рафсон поверх MNA (DC + TRAN)
2. [ ] **BJT / MOSFET** — Эберс-Молл / level 1
3. [ ] **DC sweep** + несколько независимых источников
4. [ ] **График**: курсоры, экспорт CSV

## Фаза 12 — PCB Pro 🟩

Скиллы: `/ucp-web-impl-pcb-drc`, `/ucp-web-impl-pcb-edit`.

1. [ ] **Clearance-DRC** — зазоры дорожка-дорожка / дорожка-пад / min width
2. [ ] **Ручное редактирование дорожек** — перетаскивание сегментов, удаление, переразводка
3. [ ] **Copper pour** — полигон GND с термобарьерами (упрощённо)
4. [ ] **Контур платы + silkscreen** — в Gerber-комплект
5. [ ] **Pick-and-place CSV** — координаты/поворот/слой для монтажа
